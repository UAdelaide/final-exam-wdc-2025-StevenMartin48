...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES ((SELECT user_id FROM Dogs WHERE name = ''), '2025-06-10 08:00:00', 30, 'Parklands', 'open');
